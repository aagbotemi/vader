...
const Hero = () => {
  ...
  return (
    <div className='font-[Archivo] bg-[url(/hero.svg)] bg-center bg-no-repeat bg-cover w-full h-[calc(100vh-8rem)]'>
      <div className='max-w-[1280px] mx-auto pl-4 pr-5 px-[15px] md:px-[50px] lg:px-[112px] '>
        ...
        <div className="pt-[175px]">
          ...
          <div className="mt-4 text-[#FDFDFD] text-[42px] leading-[44px] font-semibold">
          ...
          <div className="text-white mt-[18px] flex items-center font-medium text-[16px] leading-[20px]">
            ...
            <span className="ml-4 border border-[#FFFFFF] py-2 px-4 rounded-3xl">16+</span>
          </div>

          <div className="mt-6 text-[#FDFDFD] text-[16px] leading-[20px] max-w-[520px]">
